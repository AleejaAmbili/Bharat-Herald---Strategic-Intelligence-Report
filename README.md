...
Evaluate ad revenue trends across categories


Assess print inefficiencies (waste & returns)


Measure digital pilot performance


Recommend a data-driven digital strategy
...
Jaipur → High waste, needs optimization
...
Low engagement despite investment


Clear mismatch between product and user behavior
...
📁 BharatHerald_Dashboard.html 

📂 Dataset & Analysis


Primary & secondary analysis performed on multi-source data


Covered circulation, revenue, and digital metrics 
...
Identifying real-world operational inefficiencies


Connecting digital metrics with revenue impact
...
Make this more ATS/recruiter optimized


Add GitHub badges + visuals


Or convert it into a portfolio-level project (top 1% quality)
